	        ...
	        <app-iphone-x>
		        <view slot="empty-area" class='lottery-bottom dir-left-nowrap cross-center'>
			        <view @click="nav1" class="box-grow-1 dir-left-nowrap main-center cross-center">
				        <icon class="icon icon-hf" :class="status==='index' ?  theme+ '-m-back ' + theme: 'gray-back'"></icon>
				        <view  :class="status ==='index' ? theme+ '-m-text ' + theme : 'gray'">砍价会场</view>
			        </view>
			        <view class="line"></view>
			        <view @click="nav2" class="box-grow-1 dir-left-nowrap main-center cross-center">
				        <icon class="icon icon-jf" :class="status !=='index' ?  theme+ '-m-back ' + theme: 'gray-back'"></icon>
				        <view :class="status !=='index' ? theme+ '-m-text ' + theme : 'gray'">我的砍价</view>
			        </view>
		        </view>
	        </app-iphone-x>
        </view>
