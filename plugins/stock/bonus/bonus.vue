<template>
    <app-layout>
        <view class="header cross-center dir-top-nowrap" :style="{'background-image': `url(${stock.bonus})`}">
            <view>{{setting.form.bonus_title ? setting.form.bonus_title : '股东分红'}}(元)</view>
        ...
        <view class="cell">
            <view class="main-between cell-item">
                <view class="label">{{setting.form.bonus_total ? setting.form.bonus_total : '可提现分红'}}</view>
                <view>{{detail.total_bonus ? detail.total_bonus: '0.00'}}元</view>
            </view>
        </view>
        <view class="cell">
            <view class="main-between cell-item">
                <view class="label">{{setting.form.bonus_cash ? setting.form.bonus_cash : '已提现分红'}}</view>
                <view>{{detail.cash_bonus ? detail.cash_bonus : '0.00'}}元</view>
            </view>
            <view class="main-between cell-item">
                <view class="label">{{setting.form.bonus_loading ? setting.form.bonus_loading : '待打款分红'}}</view>
