                ...
                <view class="app-price-button dir-left-nowrap main-between cross-bottom">
                    <view class="price dir-top-nowrap main-right">
                        ...
                        <view class="app-price dir-left-nowrap cross-bottom">
                            <text class="app-symbol app-now-price" :class="themeObject.color" v-if="item.price > 0">{{item.price}}</text>
                    ...
                    <view v-if="item.goods_stock > 0" class="app-button" :class="themeObject.theme === 'a' ? 'default-button' : themeObject.back">去开团</view>
