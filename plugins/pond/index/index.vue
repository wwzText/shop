    ...
    <view class="app-layout">
        <app-layout :haveBackground="false">
            <view class="pond">
                ...
                <view class="pond-box"
                      :style="{height: 'calc(100vh - 480rpx - ' + `${bottomHeight}` + 'rpx)',
                ...
                <view class="act-modal">
                    ...
                    <view class="act-modal-pic cross-center main-center">
                        <view class="act-modal-info success">
                            <icon class="image-bg" :style="{'background-image': `url(${appImg.pond_success})`}">></icon>
                            <view @click="closeActModal">
                                <icon class="image-close"></icon>
                            </view>
                ...
                <view class="act-modal show">
                    ...
                    <view class="act-modal-pic cross-center main-center">
                        <view class="act-modal-info error">
                            <icon class="image-bg" :style="{'background-image': `url(${appImg.pond_empty})`}">></icon>
                            <view @click="closeActModal">
                                <icon class="image-close"></icon>
                            </view>
                            <view class="main-center">
