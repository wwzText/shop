        ...
        <block v-for="(v,k) in list" :key="k">
            <view class="dir-left-nowrap line cross-center">
                ...
                <view class="box-grow-0">
                    <app-button @click="submit(v)" v-if="v.status == 0 && v.type == 4" background="#FFFFFF" height="56" width="164" color="#FF4544" font-size="28" round>立即兑换</app-button>
                    <app-button v-if="v.status == 1 && v.type == 4" background="#CDCDCD" height="56" width="164" color="#FFFFFF" font-size="28" disabled round>已兑换</app-button>
                    <app-button v-if="v.status == 1 && v.type != 4" background="#CDCDCD" height="56" width="164" color="#FFFFFF" font-size="28" disabled round>已发放</app-button>
                </view>
            </view>
        </block>
    </app-layout>
