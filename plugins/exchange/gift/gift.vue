        ...
        <scroll-view scroll-y :style="{'height':`${windowHeight}px`}">
            <view class="app-goods" v-show="loading">
                ...
                <view class="other-info">
                    ...
                    <view class="code" :class="status == 'unused' ? getTheme + '-m-text ' + getTheme + '-m-back-o ' + getTheme:'default'">{{code}}</view>
                ...
                <view class="safe-area-inset-bottom u-bottom-fixed">
                    <view class="buttons dir-left-nowrap">
                        <view class="app-button main-center cross-center">
                            <view @click="copy" v-if="status == 'unused'" class="app-exhange" :class="getTheme === 'b' || getTheme === 'a' || getTheme === 'f' ? getTheme + '-s-gradient-o ' + 'text ' + getTheme : getTheme + '-s-gradient-o ' + getTheme + '-m-text ' + getTheme"
                              >
                                复制兑换码
                            </view>
                            <view @click="toExchange" style="color: #fff" v-if="status == 'unused'" class="app-exhange" :class="getTheme + '-m-gradient-o ' + getTheme">
                                立即兑换
                            </view>
