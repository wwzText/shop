	...
	<view class="app-price-title-share">
		...
		<view class="app-content dir-left-nowrap main-between">
			<view class="app-price">
				<view v-if="level_show === 1" class="dir-left-nowrap main-left cross-bottom" :class="theme">
					<text class="app-member-price" :class="[theme, theme + '-m-text']">{{priceMember}}</text>
					<text class="app-member-icon" :class="[theme, theme + '-m-text', theme + '-m-border']">会员价</text>
				...
				<view class="cross-bottom dir-left-nowrap" v-else>
					<text class="app-unmember-price" :class="[theme, theme + '-m-text']">{{price}}</text>
                     <app-sup-vip :is_vip_card_user="is_vip_card_user" margin="0 0 10rpx 13rpx" v-if="discount" :discount="discount"></app-sup-vip>
				</view>
				<view class="app-original-price">
					<text v-if="level_show != 1" class="app-p">￥{{original_price}}</text>
					<text v-else class="app-miaosha" :class="[theme, theme + '-m-text']">￥{{price}}</text>
