        ...
        <view class="bg">
            ...
            <template v-if="list.status===`2` && list.lottery.type !=2">
                ...
                <view @click="prize" class="cross-center main-center dir-left-nowrap detail-lucky">
                    <view>查看我的幸运码</view>
                    <icon class="icon-arrow-right-white"></icon>
                </view>
            </template>
            ...
            <view v-if="list" class="detail-center-a">
