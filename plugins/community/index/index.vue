            ...
            <view v-if="list.length > 0">
                <view v-for="(item,index) in list" :key="item.id" class="list">
                    <view class="title main-between cross-center">
                        ...
                        <view class="status-text" :class="getTheme + '-m-text ' + getTheme">{{item.statusText}}</view>
                    </view>
                    ...
                    <view class="main-between cross-center other">
                        ...
                        <view class="dir-right-nowrap">
                            ...
                            <view @click="toRemind(item.id,index)" class="other-button" :class="getTheme + '-m-text ' + getTheme + ' ' +getTheme + '-m-border ' + getTheme" v-if="item.status_name == '已结束' && item.is_success == 1 && item.is_remind == 0">通知提货</view>
            ...
            <view v-if="showRemind" class="dialog-bg main-center cross-center">
                <view class="dialog">
                    ...
                    <view class="dialog-btn main-between">
                        ...
                        <view @click="remind" class="btn" :class="getTheme + '-m-text ' + getTheme">确认</view>
                    </view>
                </view>
            </view>
