    ...
    <app-layout>
        ...
        <view v-if="!first" class="head-card" :style="[{'background-color': `${list.form.card_bg}`}]">
            ...
            <view class="card-name dir-left-nowrap" :style="[{'color': `${list.form.card_color}`}]">
                ...
                <view v-if="user.order.length > 0" @click="toggleLog" class="buy-log dir-left-nowrap cross-center"><view>购买记录</view><image class="buy-log-icon" src="./../image/right.png"></image></view>
            </view>
            <view class="open-info" :style="[{'color': `${list.form.card_color}`}]">
                ...
                <view class="userDay" v-if="user && user.expire > 0">累积剩余{{user.expire}}天</view>
                <view class="userDay" v-if="user && user.expire < 1">已过期</view>
            </view>
        ...
        <view>
            <view class="list" v-for="(item,index) in list.form.sort" :key="index">
                ...
                <!-- 开卡即赠 -->
                <view v-if="item == 'gift' && (detail.send_integral_num > 0 || detail.send_balance > 0 || detail.vipCoupons.length > 0 || detail.vipCards.length > 0)" class="item">
                    <view class="item-title main-center cross-center">
                        <image :src="svipImg.left" alt=""></image>
                    ...
                    <view v-if="detail.vipCoupons.length > 0" class="dir-left-nowrap cross-center item-gift coupon">
                    ...
                    <view v-if="detail.vipCoupons.length > 0" class="coupon-list">
                    ...
                    <view v-if="detail.vipCards.length > 0" class="dir-left-nowrap cross-center item-gift coupon">
                    ...
                    <view v-if="detail.vipCards.length > 0" class="card-list">
        ...
        <view v-if="showLog" class="bg main-center cross-center">
            <view class="dialog buy-log">
                ...
                <view class="log-list">
                    <view v-for="(item,index) in user.order" :key="index" class="log-item main-center">
        ...
        <view>
            <app-share-qr-code :theme="getTheme" v-model="showShare" :url="poster" title="生成海报"></app-share-qr-code>
        </view>
    </app-layout>
</template>
