                ...
                <view>
                    ...
                    <view class="dir-left-nowrap cross-center">
                        <view class="level" @click="toUpdate">
                            ...
                            <image v-if="detail.is_up == 1 && detail.level_up_log.status != 2" class="is-up" src="./../../image/up.png"></image>
                            <image v-if="detail.is_up == 1 && detail.level_up_log.status == 2" class="is-up" src="./../../image/up-lose.png"></image>
                            <image v-if="detail.is_up == 0 && detail.level_up_log.status == 1" class="is-up" src="./../../image/up-success.png"></image>
                        </view>
