					...
					<view class="item-content dir-top-nowrap main-between">
						<view>
							...
							<view class="item-time dir-left-wrap">
								...
								<text class="text-time" :class="theme.color">{{item.html}}</text>
							</view>
						</view>
						<view class="price-button dir-left-nowrap main-between">
							<view class="price">
								<text class="symbol" :class="theme.color" v-if="item.use_attr == 0">定金￥{{Number(item.advanceGoods.deposit)}}抵￥{{Number(item.advanceGoods.swell_deposit)}}</text>
								<text class="symbol" :class="theme.color" v-if="item.use_attr == 1">定金￥{{Number(item.attr[0].deposit)}}抵￥{{Number(item.attr[0].swell_deposit)}}</text>
								...
								<view class="all-price">
									<text class="new-price" :class="theme.color">￥{{Number(item.price)}}</text>
									<text class="old-price">￥{{Number(item.original_price)}}</text>
								</view>
							</view>
							<view v-if="item.goods_stock > 0" class="button" :class="theme.back">抢购</view>
						</view>
					</view>
				</view>
			</app-form-id>
