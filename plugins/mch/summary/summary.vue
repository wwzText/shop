<template>
    <app-layout>
        <view class="summary-head">
            <image class="shop-pic" :src="shop.store.pic_url[0].pic_url" lazy-load></image>
            <view class="home cross-center" @click="navHome">
                <image src="../../../static/image/icon/arrow-left-white.png"></image>
                <view>返回店铺首页</view>
            </view>
        ...
        <view class="summary-info">
            ...
            <view class="dir-left-nowrap tag" v-if="shop.store.address">
                ...
                <view class="dir-left-nowrap">
                    <view :class="shop.distance ? 'max':''">{{shop.store.address}}</view>
                    <view @click="mapPower" v-if="shop.distance" class="box-grow-0 main-center cross-center tv">导航
                    </view>
                </view>
            </view>
