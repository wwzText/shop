    ...
    <app-layout>
        <view class="shop" :class=" fixed ? `shop-tab-` + tab:``">
            ...
            <view class="shop-head">
                ...
                <view class="black">
                    <image :src="detail.store.pic_url[0].pic_url" class="shop-pic" lazy-load mode="aspectFill"></image>
                </view>
            ...
            <view class="cross-center main-center shop-tab">
                ...
                <view class="cross-center main-center box-grow-1" style="padding: 0 32rpx">
                    <view @click="tabChange(1)" class="cross-center main-center box-grow-1 dir-top-nowrap">
                        <view :class="tab === 1 ? getTheme + '-m-text ' + getTheme : ''">首页</view>
                        <view v-if="tab === 1" class="shop-tab-active" :class="getTheme + '-m-back ' + getTheme"></view>
                    </view>
                    <view @click="tabChange(2)" class="cross-center main-center box-grow-1 dir-top-nowrap">
                        <view :class="tab === 2 ? getTheme + '-m-text ' + getTheme : ''">全部</view>
                        <view v-if="tab === 2" class="shop-tab-active" :class="getTheme + '-m-back ' + getTheme"></view>
                    </view>
                    <view @click="tabChange(5)" class="cross-center main-center box-grow-1 dir-top-nowrap">
                        <view :class="tab === 5 ? getTheme + '-m-text ' + getTheme : ''">新品</view>
                        <view v-if="tab === 5" class="shop-tab-active" :class="getTheme + '-m-back ' + getTheme"></view>
                    </view>
            ...
            <block v-if="tab === 2">
                <view class="dir-left-nowrap shop-all">
                    <view class="box-grow-1 dir-left-nowrap main-center cross-center" @click="navCat">
                        <view>分类</view>
                        <icon class="icon-cat"></icon>
                    </view>
                    <view class="box-grow-1 dir-left-nowrap main-center cross-center" @click="changeStyle(1)">
                        <view :class="sort === 1 ?  getTheme + '-m-text ' + getTheme : ''">综合</view>
                    </view>
                    <view class="box-grow-1 dir-left-nowrap main-center cross-center" @click="changeStyle(4)">
                        <view :class="sort === 4 ?  getTheme + '-m-text ' + getTheme : ''">销量</view>
                    </view>
                    <view class="box-grow-1 dir-left-nowrap main-center cross-center" @click="changeStyle(3)">
                        <view :class="sort === 3 ? getTheme + '-m-text ' + getTheme : ''">价格</view>
                        <icon v-if="sort === 3 && sort_type === 1" class="icon-price-plus" :class="getTheme + '-m-text ' + getTheme + '-m-back ' +  getTheme"></icon>
                        <icon v-else-if="sort === 3 && sort_type === 0" class="icon-price-less" :class="getTheme + '-m-text ' + getTheme + '-m-back ' +  getTheme"></icon>
                        <icon v-else class="icon-price-default"></icon>
                    </view>
                </view>
                <u-ordinary-list :reset="reset" :pagination="true" :isShowAttr="true" :previewUrl="order_preview" :submitUrl="order_submit" :list="goods_list" :theme="getTheme" :list-style="2"></u-ordinary-list>
            </block>
