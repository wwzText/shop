                ...
                <scroll-view scroll-x class="u-scroll-view" :scroll-left="0" scroll-with-animation >
                    <view class="u-tabs-scroll-box">
                        <view
                            ...
                            :class="index == getCurrent ? getTheme + '-m-text ' + getTheme : ''"
                        ...
                        <view
                            class="u-scroll-bar"
                            :style="'transform:translateX(' + left + 'rpx)'"
            ...
            <view class="f-set" catchtouchmove="true">
                <view class="f-status dir-left-nowrap cross-center" :style="'transform:translateY(' + statusTop + 'rpx)'">
                    <view class="f-item dir-left-nowrap cross-center main-between" @click="setDef('left')"
                          :class="rotate.left === 180 ? 'f-set ' + getTheme + '-m-text ' + getTheme : 'f-def-set'">
                        <view>
                            <text class="t-omit">{{leftSet | category}}</text>
                        </view>
                        <image :class="rotate.left === 180 ?  getTheme + '-m-back ' + getTheme : 'f-img'"
                               src="/static/image/icon/favorite/bottom.png" :style="'transform:rotate(' + rotate.left + 'deg)'"></image>
                    </view>
                    <view class="f-item dir-left-nowrap cross-center main-between" @click="setDef('right')"
                          :class="rotate.right === 180 ? 'f-set ' + getTheme + '-m-text ' + getTheme : 'f-def-set'">
                        <view>
                            <text class="t-omit">{{rightSet | setStatus}}</text>
                        </view>
                        <image :class="rotate.right === 180 ?  getTheme + '-m-back ' + getTheme : 'f-img'"
                               src="/static/image/icon/favorite/bottom.png" :style="'transform:rotate(' + rotate.right + 'deg)'"></image>
                    </view>
                    <view class="f-good-btn" @click="edit">
                        {{touch ? '完成' : '管理'}}
                    </view>
                    <image class="f-good-icon" @click="setListStyle()"
                ...
                <view class="f-select" :style="'transform:translateY('+ typeY+'rpx)'">
                    <scroll-view scroll-y>
                        <view class="dir-left-wrap f-type">
                            <view class="f-type-item" @tap="setStatus(it.id)"
                                  v-bind:class="selectStatus == it.id ? getTheme + '-m-text ' + getTheme : 'f-type-def'"
                    ...
                    <view class="f-button dir-left-nowrap">
                        ...
                        <button class="box-grow-1" @click="sureStatus(1)" :class="getTheme + '-m-back ' + getTheme">确定</button>
                    </view>
                </view>
            </view>
                ...
                <block v-if="listStyle" >
                    ...
                    <view class="dir-left-nowrap" v-for="(item, index) in list" :key="index">
                        ...
                        <good-action style="width: 750rpx" :index="index"  :theme="getTheme"
                                     ...
                                     :disabled="touch"
                                     :show="item.show">
                            <view class="f-item u-border-bottom dir-left-nowrap" @click="route(item)">
                                    ...
                                    <view>
                                        ...
                                        <view class="dir-left-nowrap main-between" v-if="item.status_type !== 3">
                                            <view class="dir-top-wrap main-between">
                                                <text class="f-price" :class="getTheme + '-m-text ' + getTheme">{{item.price_content}}</text>
