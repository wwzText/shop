	...
	<app-layout>
		<view class="page" :style="{ height: height }">
			...
			<view class="close" @click.stop="close">
				<image class="image" src="../../static/image/video-close.png"></image>
			</view>
			<view
				...
				<view class="dir-left-nowrap cross-bottom">
											...
											<view class="pri-but dir-left-nowrap main-between cross-bottom">
												<view>
													<view class="dir-left-nowrap">
														...
														<!-- 超级会员卡 -->
														<view class="app-sup-vip" v-if="goods_list[cur_index].vip_card_appoint.discount">
															<app-sup-vip
													...
													<view class="pri">
														<text class="price" :class="sign === 'gift' ? theme + '-color '+ theme : getTheme + '-m-text '+ getTheme">{{goods_list[cur_index].price_content}}</text>
					...
					<view class="right dir-left-nowrap">
						<view class="but index" @click.stop="routeGo('/pages/index/index')">
							<view class="icon">
								<image class="image" src="../../static/image/video-index.png"></image>
							</view>
							<text>首页</text>
						</view>
						<view class="but cart" @click.stop="specification(goods_list[cur_index])">
							<view class="icon">
								<image class="image" src="../../static/image/video-card.png"></image>
							</view>
							<text>加购</text>
						</view>
						<view class="but" >
							<view class="icon">
								<image class="image" src="../../static/image/video-share.png"></image>
							</view>
							<text>分享</text>
			...
			<view v-if="sign === 'pintuan' && show_pt">
				<app-iphone-x>
					<view class="pintuan dir-left-nowrap" slot="empty-area">
						<view class="single box-grow-1 dir-top-nowrap" :class="getTheme === 'b' || getTheme === 'f'  || getTheme === 'a' ? getTheme + '-s-back ' + 'buy ' + getTheme : getTheme + '-s-back ' + getTheme+ '-m-text ' + getTheme"  @click="individual"
                              v-if="item && item.pintuanGoods.is_alone_buy">
							<text class="app-text">单独购买</text>
						</view>
						<view class="tuan box-grow-1 dir-top-nowrap" :class="getTheme + '-m-back '+ getTheme" @click="multiplayer">
