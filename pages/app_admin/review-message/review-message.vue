            ...
            <view class="review-message">
                ...
                <view class="search" :class="{'search-top': titleShow}">
                    ...
                    <view v-else style="position: relative">
                        <input id="search" :placeholder="type === 'mch' ? '请输入店铺名称搜索': type =='share' ? '请输入昵称或姓名搜索' : type =='community' ? '请输入姓名搜索' : '请输入昵称搜索'" v-model="keyword" type="text" focus v-if="searchBool" @focus="getFocus=true" @blur="blurFocus" class="search-view">
