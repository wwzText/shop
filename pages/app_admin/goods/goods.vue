    ...
    <app-layout>
        ...
        <view class="search main-between">
            ...
            <view v-else class="dir-left-nowrap" style="position: relative">
                <input focus placeholder="请输入商品名称搜索" class="box-grow-1 t-small search-content" @confirm='reload' confirm-type='search' @focus="getFocus=true" v-model='keyword'></input>
        ...
        <app-tab-nav setTop="88" :tabList="tabList" padding="0" :activeItem="activeTab" @click="tabStatus" theme="blue"></app-tab-nav>
