    ...
    <app-layout>
        <view class="search-mode">
            <view class="search-input">
                <input type="text"confirm-type='search' v-model='keyword' placeholder-style='color:#999999;font-size:13px;' placeholder='请输入订单号/商品名称/收货人姓名/联系电话'>
            ...
            <view>
               <app-iphone-x>
                    <view class="search-menu main-center" slot="empty-area">
                        ...
                        <view @click="toSearch" style="color: #fff" class="box-grow-1 search-menu-item" :class="getTheme + '-m-back ' + getTheme">搜索</view>
                    </view>
               </app-iphone-x>
           </view>
        </view>
