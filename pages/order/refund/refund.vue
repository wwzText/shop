<template>
    <app-layout>
        <view v-if="is_show">
            <view class="refund-box">
                ...
                <view class="content">
                    <view class="content-item" v-if="form.type == 3">
                        ...
                        <view class="select-box" @click="goodsStatus.visible = true">
                    ...
                    <view class="content-item" v-if="form.type != 2">
                        ...
                        <view class="select-box" @click="refundList.visible = true">
            ...
            <app-select height="264rpx" title="货物状态" :is-show="goodsStatus.visible" :value="goodsStatus.index" :list="goodsStatus.list" @confirm="goodsStatusChange"></app-select>
            <app-select title="退款原因" :is-show="refundList.visible" :value="refundList.index" :list="refundList.list" @confirm="refundListChange"></app-select>
        </view>
    </app-layout>
</template>
<script>
