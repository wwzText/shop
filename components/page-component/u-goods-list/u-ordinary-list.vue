    ...
    <view class="u-list" v-show="is_show_off">
            ...
            <scroll-view scroll-x v-bind:class="[theme, 'u-scroll-view', 'dir-left-nowrap']">
                <text
                    ...
                    v-bind:class="[
                        ...
                        'u-active-current-round ' + theme + '-m-back ' + theme  :
                        catStyle === 1 && activeCurrent === index ?
                        'u-active-current '+ theme + '-m-text ' + theme + ' ' + theme+ '-m-border': 'u-default-text',
        ...
        <view v-bind:class="goodsListClass">
                    ...
                    >
                        ...
                        <view class="box-grow-1 u-right dir-top-nowrap main-between">
                            <view
                                ...
                                v-bind:class="[
                                    goods.vip_card_appoint.discount || ((goods.level_show === 1 || goods.level_show === 2) && goods.is_negotiable !== 1) ? 't-omit' : 't-omit-two',
            ...
            <template v-else-if="listStyle === 0">
               <scroll-view scroll-x class="u-swipe-left-right ">
            ...
            <template v-else-if="listStyle === 1">
               <block v-for="(goods, index) in goodsList" v-bind:key="index">
                   <view hover-class="goods-hover-class" v-bind:class="goodsStyleObject" v-on:click.stop="router(goods)" class="u-one-per-line" >
                       ...
                       <view v-if="showGoodsName" v-bind:class="[textAlign, 'u-goods-name', 't-omit']" >
                           {{goods.name}}
                       </view>
                       <view class="u-bottom dir-left-nowrap cross-center">
                           <view v-bind:class="[theme + '-m-text ', theme, 'box-grow-1', 'u-price']">
               ...
               <block v-for="(goods, index) in goodsList" v-bind:key="index">
                   ...
                   >
                       <view class="u-top box-grow-0">
                           ...
                           <app-image
                               borderRadius="16rpx 16rpx 0 0"
                               :width="goodsStyle === 2 ? '344rpx': '346rpx'"
                               height="346rpx"
                               v-bind:img-src="goods.cover_pic"
                               v-bind:mode="mode"
                           ></app-image>
                           ...
                           <view class="box-grow-0 u-price dir-left-nowrap cross-bottom main-between" >
                               <view class="box-grow-1">
                                  <view v-if="goods.sign == 'pick' && activity" class="u-margin dir-left-nowrap cross-bottom">
                                      <text :class="[themeObject.back, 'u-des-price']">
                                  ...
                                  <view v-if="goods.sign === 'flash_sale'" class="u-margin dir-left-nowrap cross-bottom">
                                      <text v-if="goods.discount_type === 1" :class="[themeObject.back, 'u-des-price']">{{goods.min_discount}}折
                                      </text>
                                      <text v-if="goods.discount_type === 2" :class="[themeObject.back, 'u-des-price']">减{{goods.min_discount}}元
                                      </text>
                                  </view>
                                   <view
                                     ...
                                     >
                                       <app-member-price :theme="themeObject" v-bind:price="goods.level_price"></app-member-price>
                                   </view>
                                   <view
                                   ...
                                   <view  v-if="showGoodsPrice || isShowOriginalPrice(goods)"
                                       ...
                                       <text v-if="showGoodsPrice" v-bind:class="[theme + '-m-text ', theme, 't-omit', 'u-goods-price', textAlign]">
                                           {{goods.price_content}}
                                       </text>
                                       <text v-if="isShowOriginalPrice(goods)" v-bind:class="[goods.is_sales === 1 ? 'u-original-margin' : '', 'u-original-price',  textAlign]">
                                           ￥{{goods.original_price}}
                                       </text>
                                   </view>
