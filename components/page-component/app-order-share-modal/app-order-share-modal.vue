        ...
        <view class="modal">
            ...
            <view class="content">
                <template v-if="share_setting.become_condition == 1">
                    <view class="mb-24">您单次消费满<text :class="getTheme + '-m-text ' + getTheme">￥{{share_setting.auto_share_val}}</text></view>
                </template>
                <template v-if="share_setting.become_condition == 4">
                    <view class="mb-24">您累计消费满<text :class="getTheme + '-m-text ' + getTheme">￥{{share_setting.total_consume}}</text></view>
                </template>
            ...
            <view class="footer dir-left-nowrap cross-center">
                ...
                <view class="box-grow-1" :class="getTheme + '-m-text ' + getTheme"
