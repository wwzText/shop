<template>
    <view class="app-index-wholesale">
                ...
                <app-form-id @click="jump_router(item)">
                    <view class="item box-grow-0 dir-top-nowrap">
                        ...
                        <view class="box-grow-1 dir-top-nowrap main-right">
                            ...
                            <view v-if="item.is_negotiable == 1" class="price" :class="theme.color">价格面议</view>
                            <view v-if="item.is_negotiable == 0" :class="theme.color"  class="price dir-left-nowrap">
        ...
        <view v-if="style === '2'">
            <u-ordinary-list :theme-object="theme" :showBuyBtn="false" :theme="getTheme" :list-style="2" :list="newData"></u-ordinary-list>
        </view>
    </view>
</template>
