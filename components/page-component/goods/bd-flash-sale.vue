<template>
    <view class="f-flash">
        <view class="f-con cross-center" :class="theme.theme !== 'a' ? theme.backP : ''"
              :style="{backgroundImage: theme.theme === 'a' ? `url(${flashSale.cover})` : ''}" @click="navigator">
            <view class="f-sign" :class="theme.back">限时抢购</view>
            <view class="f-title">
            ...
            <view class="f-text" :class="theme.color">
                点我去{{flashSale.time_status == 1 ? '加' : '抢'}}购
            </view>
